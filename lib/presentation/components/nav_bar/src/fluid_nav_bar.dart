...
import 'package:ustahub/presentation/components/nav_bar/src/curves.dart';
import 'package:ustahub/presentation/components/nav_bar/src/fluid_nav_bar_icon.dart';
import 'package:ustahub/presentation/components/nav_bar/src/fluid_nav_bar_item.dart';
import 'dart:ui' as ui;

import 'package:ustahub/presentation/components/nav_bar/src/fluid_nav_bar_style.dart';

typedef FluidNavBarChangeCallback = void Function(int selectedIndex);

typedef FluidNavBarItemBuilder =
    Widget Function(FluidNavBarIcon icon, FluidNavBarItem item);
...
class _BackgroundCurvePainter extends CustomPainter {
  ...
  void paint(canvas, size) {
    ...
    path_0.cubicTo(
      ...
      x0 + 45,
      size.height * 0.4244000,
      x0 + 45,
      size.height * 0.1666667,
    );
    path_0.cubicTo(
      x0 + 45,
      size.height * 0.1079468,
      x0 + 44.5,
      size.height * 0.05176000,
      x0 + 43,
      0,
    );
    path_0.lineTo(size.width * 0.9487179, 0);
    path_0.cubicTo(
      size.width * 0.9770410,
      0,
      size.width,
      size.height * 0.1492385,
      size.width,
    ...
    path_0.cubicTo(
      0,
      size.height * 0.1492383,
      size.width * 0.02295977,
      0,
