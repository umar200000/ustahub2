...
import 'package:ustahub/infrastructure/services/alice/model/alice_export_result.dart';
import 'package:ustahub/infrastructure/services/alice/model/alice_http_call.dart';
import 'package:ustahub/infrastructure/services/alice/model/alice_translation.dart';
import 'package:ustahub/infrastructure/services/alice/ui/call_details/model/alice_menu_item.dart';
import 'package:ustahub/infrastructure/services/alice/ui/calls_list/model/alice_calls_list_sort_option.dart';
import 'package:ustahub/infrastructure/services/alice/ui/calls_list/model/alice_calls_list_tab_item.dart';
import 'package:ustahub/infrastructure/services/alice/ui/calls_list/widget/alice_inspector_screen.dart';
import 'package:ustahub/infrastructure/services/alice/ui/calls_list/widget/alice_logs_screen.dart';
import 'package:ustahub/infrastructure/services/alice/ui/calls_list/widget/alice_sort_dialog.dart';
import 'package:ustahub/infrastructure/services/alice/ui/common/alice_context_ext.dart';
import 'package:ustahub/infrastructure/services/alice/ui/common/alice_dialog.dart';
import 'package:ustahub/infrastructure/services/alice/ui/common/alice_navigation.dart';
import 'package:ustahub/infrastructure/services/alice/ui/common/alice_page.dart';
import 'package:ustahub/infrastructure/services/alice/ui/common/alice_theme.dart';
...
class _AliceCallsListPageState extends State<AliceCallsListPage>
  ...
  void _saveToFile() async {
    ...
    if (result.success) {
      await _handleFileSaving(result);
    } else {
  ...
  /// Handle file saving using share_plus
  Future<void> _handleFileSaving(AliceExportResult result) async {
    if (result.path != null) {
